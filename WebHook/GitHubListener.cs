...
{
    public class GitHubListener : IGitHubListener
    {
        private static readonly Dictionary<ulong, GitHubListener> _createdListeners = new Dictionary<ulong, GitHubListener>();
